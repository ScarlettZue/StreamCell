...
export const ClientsPage: React.FC = () => {
  ...
  const updateMutation = useMutation({
    ...
    onError: (err: any) => {
      setModalError(err.response?.data?.message || 'Error al actualizar el cliente. Inténtalo de nuevo.');
    },
  });
  ...
  return (
    <MainLayout
      ...
      subtitle="Búsqueda por nombre o celular y consulta detallada de historial comercial"
    >
      <div className="space-y-6">
        {/* Búsqueda por Nombre o Celular & Nuevo Cliente */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 px-5 py-2.5 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl text-sm font-bold shadow-md hover:opacity-95 transition-all"
          >
