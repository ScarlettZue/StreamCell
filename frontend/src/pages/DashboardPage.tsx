  ...
  return (
    ...
    >
      <div className="space-y-8">
        ...
        <div className="p-6 rounded-3xl bg-gradient-to-r from-brand-blue/20 via-brand-purple/20 to-slate-900 border border-brand-purple/30 flex flex-col md:flex-row items-center justify-between gap-4 shadow-glass">
          ...
          <div className="px-4 py-2 rounded-xl bg-slate-900/80 border border-slate-700/60 text-xs font-semibold text-brand-blue-light flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="glass-card p-6 rounded-2xl border border-slate-800/80">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="w-10 h-10 rounded-xl bg-brand-blue/20 text-brand-blue-light flex items-center justify-center">
                <DollarSign className="w-5 h-5" />
              </div>
            </div>
            <h3 className="text-2xl font-extrabold text-white">{formatCurrency(metrics.totalRevenue)}</h3>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800/80">
            ...
            <h3 className="text-2xl font-extrabold text-emerald-400">{formatCurrency(metrics.totalProfit)}</h3>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800/80">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="w-10 h-10 rounded-xl bg-brand-purple/20 text-brand-purple-light flex items-center justify-center">
                <Users className="w-5 h-5" />
              </div>
            </div>
            <h3 className="text-2xl font-extrabold text-white">{totalClients}</h3>
            {totalDebt > 0 ? (
              <p className="text-xs text-rose-400 mt-2 font-bold">Por cobrar: {formatCurrency(totalDebt)}</p>
            ) : (
              <p className="text-xs text-emerald-400 mt-2 font-semibold">¡Todos al día!</p>
            )}
          </div>
          ...
          <div className="glass-card p-6 rounded-2xl border border-slate-800/80">
            ...
            <h3 className="text-2xl font-extrabold text-white">{totalAvailable} perfiles</h3>
            <p className="text-xs text-slate-400 mt-2">Listos para asignar en inventario</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="glass-panel p-6 rounded-2xl border border-slate-800">
            ...
            <ul className="space-y-3 text-sm text-slate-300">
              <li className="flex justify-between py-2 border-b border-slate-800">
                ...
                <span className="text-emerald-400 font-bold">Conectado & Sincronizado</span>
              </li>
              <li className="flex justify-between py-2 border-b border-slate-800">
                <span>Zona Horaria Oficial:</span>
                <span className="text-brand-purple-light font-bold">America/Bogota (COT)</span>
              </li>
              <li className="flex justify-between py-2 border-b border-slate-800">
              ...
              <li className="flex justify-between py-2">
                ...
                <span className="text-emerald-400 font-bold">AES-256 Activo</span>
              </li>
            </ul>
          </div>
          ...
          <div className="glass-panel p-6 rounded-2xl border border-slate-800 flex flex-col justify-between">
            ...
            <div className="mt-6 pt-4 border-t border-slate-800 flex items-center justify-between text-xs text-slate-400">
              ...
              <span className="text-brand-purple-light font-bold">Identidad Azul & Morado</span>
            </div>
          </div>
        </div>
      </div>
