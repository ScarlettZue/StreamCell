        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-800 pb-4">
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className={`flex-1 sm:flex-none px-4 py-2.5 rounded-2xl text-xs font-bold transition-all flex items-center justify-center space-x-2 ${
          ...
          <div className="relative w-full sm:w-64">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-slate-100 text-xs rounded-xl border border-slate-200 dark:border-slate-800 focus:outline-none focus:border-purple-500 w-full"
            />
          </div>
        </div>
            ...
            <div className="sm:hidden space-y-3 pb-24">
              {isLoading ? (
                ...
                filteredMotherAccounts.map((acc) => {
                  ...
                  return (
                    <div key={acc.id} className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 space-y-3 shadow-sm text-xs">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-bold text-slate-900 dark:text-white text-sm">{acc.product?.name || 'Servicio'}</h4>
                          <span className="text-[11px] text-slate-500 font-mono block truncate max-w-[200px]">{acc.email}</span>
                        </div>
                      ...
                      <div className="p-2.5 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-800 flex justify-between items-center text-[11px]">
                        <span className="text-slate-500">Perfiles Vendidos: <strong className="text-purple-600 dark:text-purple-400">{soldProf} / {totalProf}</strong></span>
